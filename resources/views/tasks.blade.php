        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12 form-group{{ $errors->has('all_employees') ? ' has-error' : '' }}">
                        <label for="all_employees" class="col-md-4 control-label">¿Mostrar a todos los empleados?</label>

                            @if ( ! empty($tasks['all_employees']) && $tasks['all_employees'] == true)
                                <input checked data-toggle="toggle" type="checkbox" name="all_employees" id="all_employees" data-on="Si" data-off="No">
                            @else
                                <input data-toggle="toggle" type="checkbox" name="all_employees" id="all_employees" data-on="Si" data-off="No">
                            @endif

                        @if ($errors->has('all_employees'))
                            <span class="help-block">
                                <strong>{{ $errors->first('all_employees') }}</strong>
                            </span>
                        @endif
                    </div>
