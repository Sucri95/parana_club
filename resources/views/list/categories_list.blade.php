        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Listado Categorías
                    <a href="{{url('categories/create')}}" class="btn-xs btn-primary pull-right" role="button">Agregar</a>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th> 
                                    @if( $item->id )
                                    <a class="btn btn-default btn-circle" href="{{ url('/categories/' . $item->id) }}"><i class="fa fa-pencil"></i></a>
